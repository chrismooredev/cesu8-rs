...
cmp --quiet random.utf8.txt <(xxd -r random.utf8.txt.xxd)

echo "cesu8 --decode random.cesu8.txt"
cmp --quiet random.utf8.txt <(./target/debug/cesu8 --decode random.cesu8.txt)
...
cmp --quiet random.cesu8.txt <(./target/debug/cesu8 random.utf8.txt)

echo "round trip `cesu8 random.txt | cesu8 --decode`"
cmp --quiet random.utf8.txt <(./target/debug/cesu8 random.utf8.txt | ./target/debug/cesu8 --decode)
